...
JINJA_ENVIRONMENT = jinja2.Environment(
    ...
    autoescape=True)
#Quartermaster Natomi - Assassin's
spool = 48
prices = [0]*(160)
...
class Provisioners(webapp2.RequestHandler):
    def get(self):
        ...
        total_buy = 0
        total_sell = 0
        c_buy,c_sell,buy,sell = cheapest(natomi)
        total_c_buy += c_buy[1]
        total_c_sell += c_sell[2]
        total_buy += buy[3]
        total_sell += sell[4]
        cheap.append(["Quartermaster Natomi",[c_buy[0],gsc(c_buy[1])],[c_sell[0],gsc(c_sell[2])],[buy[0],gsc(buy[3])],[sell[0],gsc(sell[4])]])
        c_buy,c_sell,buy,sell = cheapest(kani)
        total_c_buy += c_buy[1]
        total_c_sell += c_sell[2]
        total_buy += buy[3]
        total_sell += sell[4]
        cheap.append(["Supplymaster Kani",[c_buy[0],gsc(c_buy[1])],[c_sell[0],gsc(c_sell[2])],[buy[0],gsc(buy[3])],[sell[0],gsc(sell[4])]])
        c_buy,c_sell,buy,sell = cheapest(vec)
        total_c_buy += c_buy[1]
        total_c_sell += c_sell[2]
        total_buy += buy[3]
        total_sell += sell[4]
        cheap.append(["Quartermaster Vec",[c_buy[0],gsc(c_buy[1])],[c_sell[0],gsc(c_sell[2])],[buy[0],gsc(buy[3])],[sell[0],gsc(sell[4])]])
        c_buy,c_sell,buy,sell = cheapest(ival)
        total_c_buy += c_buy[1]
        total_c_sell += c_sell[2]
        total_buy += buy[3]
        total_sell += sell[4]
        cheap.append(["Quartermaster Ival",[c_buy[0],gsc(c_buy[1])],[c_sell[0],gsc(c_sell[2])],[buy[0],gsc(buy[3])],[sell[0],gsc(sell[4])]])
        c_buy,c_sell,buy,sell = cheapest(katren)
        total_c_buy += c_buy[1]
        total_c_sell += c_sell[2]
        total_buy += buy[3]
        total_sell += sell[4]
        cheap.append(["Steward Katren",[c_buy[0],gsc(c_buy[1])],[c_sell[0],gsc(c_sell[2])],[buy[0],gsc(buy[3])],[sell[0],gsc(sell[4])]])
        c_buy,c_sell,buy,sell = cheapest(azzi)
        total_c_buy += c_buy[1]
        total_c_sell += c_sell[2]
        total_buy += buy[3]
        total_sell += sell[4]
        cheap.append(["Supplymaster Azzi",[c_buy[0],gsc(c_buy[1])],[c_sell[0],gsc(c_sell[2])],[buy[0],gsc(buy[3])],[sell[0],gsc(sell[4])]])
        c_buy,c_sell,buy,sell = cheapest(rakatin)
        total_c_buy += c_buy[1]
        total_c_sell += c_sell[2]
        total_buy += buy[3]
        total_sell += sell[4]
        cheap.append(["Scavenger Rakatin",[c_buy[0],gsc(c_buy[1])],[c_sell[0],gsc(c_sell[2])],[buy[0],gsc(buy[3])],[sell[0],gsc(sell[4])]])
        c_buy,c_sell,buy,sell = cheapest(polly)
        total_c_buy += c_buy[1]
        total_c_sell += c_sell[2]
        total_buy += buy[3]
        total_sell += sell[4]
        cheap.append(["Forager Polly",[c_buy[0],gsc(c_buy[1])],[c_sell[0],gsc(c_sell[2])],[buy[0],gsc(buy[3])],[sell[0],gsc(sell[4])]])
        c_buy,c_sell,buy,sell = cheapest(huanya)
        total_c_buy += c_buy[1]
        total_c_sell += c_sell[2]
        total_buy += buy[3]
        total_sell += sell[4]
        cheap.append(["Supplier Huanya",[c_buy[0],gsc(c_buy[1])],[c_sell[0],gsc(c_sell[2])],[buy[0],gsc(buy[3])],[sell[0],gsc(sell[4])]])
        c_buy,c_sell,buy,sell = cheapest(jatt)
        total_c_buy += c_buy[1]
        total_c_sell += c_sell[2]
        total_buy += buy[3]
        total_sell += sell[4]
        cheap.append(["Jatt",[c_buy[0],gsc(c_buy[1])],[c_sell[0],gsc(c_sell[2])],[buy[0],gsc(buy[3])],[sell[0],gsc(sell[4])]])
        c_buy,c_sell,buy,sell = cheapest(assistant)
        total_c_buy += c_buy[1]
        total_c_sell += c_sell[2]
        total_buy += buy[3]
        total_sell += sell[4]
        cheap.append(["Supply Assistant",[c_buy[0],gsc(c_buy[1])],[c_sell[0],gsc(c_sell[2])],[buy[0],gsc(buy[3])],[sell[0],gsc(sell[4])]])
        c_buy,c_sell,buy,sell = cheapest(tinkerclaw)
        total_c_buy += c_buy[1]
        total_c_sell += c_sell[2]
        total_buy += buy[3]
        total_sell += sell[4]
        cheap.append(["Terrill Tinkerclaw",[c_buy[0],gsc(c_buy[1])],[c_sell[0],gsc(c_sell[2])],[buy[0],gsc(buy[3])],[sell[0],gsc(sell[4])]])
        ...
        template_values = {
            'prov': [["Quartermaster Natomi",natomi],["Supplymaster Kani",kani],["Quartermaster Vec",vec],
                     ["Quartermaster Ival",ival],["Steward Katren",katren],["Supplymaster Azzi",azzi],
                     ["Scavenger Rakatin",rakatin],["Forager Polly",polly],["Supplier Huanya",huanya],
                     ["Jatt",jatt],["Supply Assistant",assistant],["Terrill Tinkerclaw",tinkerclaw]],
